...
<?php
  ...
  $busca=$pdo->prepare("SELECT * FROM CHAMADO WHERE CHA_SOLICITANTE=:excluir OR CHA_RESPONSAVEL=:excluir");
  ...
  $busca=$pdo->prepare("DELETE FROM USUARIO WHERE USU_LOGIN=:excluir");
  $busca->bindValue(":excluir",$excluir);
  $busca->execute();
